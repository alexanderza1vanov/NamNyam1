...
class EditRestaurantFragment : Fragment(R.layout.fragment_create_restaurant) {

    private var _binding: FragmentCreateRestaurantBinding? = null
    private val binding get() = _binding!!

    private lateinit var viewModel: EditRestaurantViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this)[EditRestaurantViewModel::class.java]
    ...
    private fun setupToolbar() {
        binding.toolbar.title = "Редактировать ресторан"
    ...
    private fun setupStaticUi() {
        binding.btnCreateRestaurant.text = "Сохранить изменения"
    }
    ...
    private fun bindRestaurant(restaurant: RestaurantDto) {
        ...
        binding.etDescription.setText(restaurant.description.orEmpty())
        binding.etAddress.setText(restaurant.address)
        binding.etPhone.setText(restaurant.phone)
        binding.etCuisineType.setText(restaurant.cuisineType.orEmpty())
        binding.etImageUrl.setText(restaurant.imageUrl.orEmpty())
        binding.etDeliveryTime.setText(restaurant.deliveryTimeMin?.toString().orEmpty())
        binding.etDeliveryFee.setText(formatDecimal(restaurant.deliveryFee))
        binding.etMinOrderAmount.setText(formatDecimal(restaurant.minOrderAmount))
    }

    private fun submit() {
        val restaurant = currentRestaurant ?: run {
            Toast.makeText(requireContext(), "Ресторан ещё не загружен", Toast.LENGTH_SHORT).show()
            return
        }
